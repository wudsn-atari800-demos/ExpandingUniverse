;
;	>> Expanding Universe - Variant 3 - right to left <<
;
...
;
;	This version forces all particles to be small and to behave less chaotically at
...
wait	cpx $d40b	;Wait for next double scanline
	...
	ora #$fe	;Use lowest bit of previous line
	adc $00,x	;Carry will be cleared due to CPX
